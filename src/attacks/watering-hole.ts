...
export const wateringHole: AttackDefinition = {
  meta,
  appliesIf: [
    { head: '業界向け専門サイト/業界団体サイトを運営:', body: '標的組織の従業員が定期訪問するサイトは "水飲み場" の典型。' },
    { head: '顧客や取引先がよく訪れる情報サイトを運営:', body: '改ざんされる側に立つリスクは、提供している情報の価値に比例する。' },
    { head: 'WordPress などCMSで運営している:', body: 'CMSの脆弱性管理を運用に組み込んでいないと改ざんされやすい。' },
    { head: '外部広告/タグマネージャを大量に入れている:', body: '埋め込み JS は "改ざんの侵入口" になり得る。' },
    { head: '機密度の高い業界に属する組織:', body: '訪問者として標的にされる側のリスク。攻撃の検知が難しい。' }
  ],
  caseStudy:
  ...
  beginner: {
    ...
    appliesIf: [
      { head: '業界向けの情報サイトや団体サイトを運営している:', body: '業界の人が定期的に訪れるサイトは「水飲み場」として狙われやすい立ち位置です。' },
      { head: '顧客や取引先がよく訪れる情報を発信している:', body: 'そのサイトを改ざんされると、訪れる人(=狙われた組織の社員)を一網打尽にされます。' },
      { head: 'WordPress などのCMSで運営している:', body: 'CMSやプラグインの更新が止まっていると、改ざんされる確率が跳ね上がります。' },
      { head: '外部広告タグや埋め込みJSを大量に使っている:', body: '埋め込みコンテンツが改ざんの侵入口になることがあります。' },
      { head: '機密性の高い業界(防衛・エネルギー・金融など)に属している:', body: '訪問者の側に立つリスク。普段使いのサイト経由なので発見が遅れます。' }
    ],
    caseStudy:
